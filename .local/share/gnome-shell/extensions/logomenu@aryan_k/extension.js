...
var MenuButton = GObject.registerClass(class LogoMenu_MenuButton extends PanelMenu.Button {
	...
	toggleOptions(){
		...
		this.menu.removeAll()
		this.item1 = new PopupMenu.PopupMenuItem(_('Sobre meu Computador                 '))
		// this.item2 = new PopupMenu.PopupMenuItem(_('System Settings...'))
		this.item3 = new PopupMenu.PopupSeparatorMenuItem()
		this.item4 = new PopupMenu.PopupMenuItem(_('Atividades'))
		this.item5 = new PopupMenu.PopupMenuItem(_('Applicativos'))	
		this.item6 = new PopupMenu.PopupSeparatorMenuItem()
		this.item8 = new PopupMenu.PopupMenuItem(_('Terminal'))
		this.item9 = new PopupMenu.PopupMenuItem(_('Extensões'))
		...
		if (!softwarecenter_state) {
			this.item7 = new PopupMenu.PopupMenuItem(_('Ubuntu Software...'))
		...
		if(!forcequit_state) {
			...
			this.item11 = new PopupMenu.PopupMenuItem(_('Fechar'))
		...
		if (poweroption_state) {
			...
			this.item13 = new PopupMenu.PopupMenuItem(_('Modo de Descanço'))
			this.item14 = new PopupMenu.PopupMenuItem(_('Reiniciar'))
			this.item15 = new PopupMenu.PopupMenuItem(_('Desligar'))
			this.item16 = new PopupMenu.PopupSeparatorMenuItem()
			if (lockscreen_state) 
				this.item17 = new PopupMenu.PopupMenuItem(_('Modo de Descanço'))
		...
		if (lockorientation_state) {
			...
			this.item20 = new PopupMenu.PopupMenuItem(_('Bloquear Rotação'))
